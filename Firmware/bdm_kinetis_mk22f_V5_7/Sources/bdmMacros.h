 ...
 *
 * All BDM commands need to be called with interrupts disabled
...
//! Write Y (HC12)
inline USBDM_ErrorCode BDM12_CMD_WRITE_Y(uint16_t value)                        { return cmd_1W_0(_BDM12_WRITE_Y, value);       }
//! Write SP (HC12)
...
inline USBDM_ErrorCode BDMCF_CMD_READ_PSTBe(uint8_t regNo, uint8_t  value_p[4]) { return cmd_0_1L(_BDMCF_READ_PSTB|regNo,value_p); }
