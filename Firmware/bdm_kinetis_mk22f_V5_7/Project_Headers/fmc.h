...
public:
   ...
   static constexpr FmcInfo::FlashBank1Init DefaultFlashBank1InitValue {
      FmcFlashSpeculation_InstructionsAndData , // Bank 1 Flash Controller Speculation Buffer - Instructions and Data
      FmcFlashCache_InstructionsAndData,  // Bank 1 Flash Controller Cache - Instructions and Data
   };
   
   /**
    * Configure Flash Bank 1
    *
    * @param flashInit Initialisation value
    */
   static void configureFlashBank1(const FmcInfo::FlashBank1Init &flashInit) {
      flashInit.configure();
   }
