...
void mapAllPins() {
      ...
      ((PORT_Type *)PORTB_BasePtr)->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0008UL);
      ((PORT_Type *)PORTB_BasePtr)->GPCHR = 0x0303UL|PORT_GPCHR_GPWE(0x0003UL);
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = 0x0103UL|PORT_GPCLR_GPWE(0x0007UL);
      ((PORT_Type *)PORTC_BasePtr)->GPCLR = 0x0203UL|PORT_GPCLR_GPWE(0x0068UL);
