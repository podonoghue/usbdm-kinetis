...
const ClockInfo Mcg::clockInfo[] = {
   ...
   {  // ClockConfig_PEE_IRC48MHz (McgClockMode_PEE)
      ...
      Sim::DefaultSopt2Values[ClockConfig_PEE_IRC48MHz].sopt2,
      ...
      11,  // (mcg_c5_prdiv0[0]) PLL0 External Reference Divider
      ...
      6,  // (mcg_c6_vdiv0[0]) PLL0 VCO Divider (VDIV0)

      /// Status and Control Register 
      McgFastInternalClockDivider_DivBy1,  // (mcg_sc_fcrdiv[0]) Fast Internal Clock [FIRC] Reference Divider - /1

      /// Control Register 7 
      McgErcSelect_Irc48MHz,  // (mcg_c7_oscsel[0]) MCG External reference clock - IRC 48MHz clock
