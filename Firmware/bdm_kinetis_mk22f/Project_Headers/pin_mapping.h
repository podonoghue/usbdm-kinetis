...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   4: GPIOA_4              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: GPIOB_0              = PTB0(p35)                      */  { PinIndex::PTB0,         PcrValue(0x08100UL) },
         /*   1: GPIOB_1              = PTB1(p36)                      */  { PinIndex::PTB1,         PcrValue(0x08100UL) },
         /*   2: GPIOB_2              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   3: GPIOB_3              = PTB3(p38)                      */  { PinIndex::PTB3,         PcrValue(0x08100UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: GPIOC_0              = PTC0(p43)                      */  { PinIndex::PTC0,         PcrValue(0x08100UL) },
         /*   1: GPIOC_1              = PTC1(p44)                      */  { PinIndex::PTC1,         PcrValue(0x08100UL) },
         /*   2: GPIOC_2              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   3: GPIOC_3              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   4: GPIOC_4              = PTC4(p49)                      */  { PinIndex::PTC4,         PcrValue(0x08100UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: GPIOD_0              = PTD0(p57)                      */  { PinIndex::PTD0,         PcrValue(0x08100UL) },
         /*   1: GPIOD_1              = PTD1(p58)                      */  { PinIndex::PTD1,         PcrValue(0x08100UL) },
         /*   2: GPIOD_2              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   3: GPIOD_3              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   4: GPIOD_4              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   5: GPIOD_5              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   6: GPIOD_6              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   7: GPIOD_7              = PTD7(p64)                      */  { PinIndex::PTD7,         PcrValue(0x08100UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: XTAL0                = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   1: EXTAL0               = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: XTAL32               = XTAL32(p19)                    */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: EXTAL32              = EXTAL32(p20)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
...
public:
   ...
   { // ClockConfig_PEE_IRC48MHz (McgClockMode_PEE)
   ...
   static constexpr uint32_t sim_clkdiv1 = 
      ...
      SimBusClkDivider_DivBy4 | // (sim_clkdiv1_outdiv2[0]) Bus Clock Divider (OUTDIV2) - Divide by [1-16] - /4
      SimFlexbusClkDivider_DivBy4 | // (sim_clkdiv1_outdiv3[0]) Flexbus Clock Divider (OUTDIV3) - Divide by [1-16] - /4
      SimFlashClkDivider_DivBy6;  // (sim_clkdiv1_outdiv4[0]) Flash Clock Divider (OUTDIV4) - Divide by [1-16] - /6;
...
public:
   ...
   public:
      ...
      ///  Hardware trigger values: ADC Channel number and Action on conversion completion values
      ...
      constexpr Init(
         ...
         sc1[adcPretrigger] = adcChannelNum|adcAction;
      }
       ...
       * @param    rest
       *
       * @param adcContinuous Selects between single and continuous conversion
       */
      template <typename... Types>
      ...
      /**
       * Constructor for Long Sample Time Select
       *
       * @tparam   Types
       * @param    rest
       *
...
public:
    ...
    */
   static constexpr Init DefaultInitValue = {
      AdcClockSource_Asynch , // (adc_cfg1_adiclk) ADC Clock Source - Asynchronous clock (ADACK)
      AdcResolution_8bit_se , // (adc_cfg1_mode) ADC Resolution - 8-bit unsigned (single-ended mode)
      AdcPower_Normal , // (adc_cfg1_adlpc) Low-Power Configuration - Normal power configuration
      AdcSample_4cycles , // (adc_sample) Long Sample Time Select - 4 ADCK total
      ...
      AdcRefSel_VrefHL , // (adc_sc2_refsel) Voltage Reference Selection - VRefH and VRefl
      ...
      AdcTrigger_Software , // (adc_sc2_adtrg) Conversion Trigger Select - Software trigger (write to SC1A)
      AdcAveraging_off , // (adc_sc3_avg) Hardware Average Select - 1 sample
      AdcContinuous_Disabled , // (adc_sc3_adco) Single or continuous conversion - Single conversion on each trigger
      AdcCompare_Disabled , // (adc_sc2_compare) Compare function - No comparison done
      0 , // (adc_cv1) ADC CV low value
      0,  // (adc_cv2) ADC CV high value
   };
   ...
   static void configure(const Init &init) {
      ...
      if (init.sc2 & ADC_SC2_ADTRG_MASK) {
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: ADC0_SE0             = ADC0_DP0(p9)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: ADC0_SE1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   2: ADC0_SE2             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   3: ADC0_SE3             = ADC1_DP0(p11)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   4: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*   5: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*   6: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*   7: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         ...
         /*  10: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  11: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  12: ADC0_SE12            = PTB2(p37)                      */  { PinIndex::PTB2,         PcrValue(0x08000UL) },
         ...
         /*  19: ADC0_SE19            = ADC0_DM0(p10)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         ...
         /*  23: ADC0_SE23            = DAC0_OUT(p18)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  24: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  25: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  PinIndex                PCR value
            /*   0: ADC0_DP0             = ADC0_DP0(p9)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
            /*   1: ADC0_DP1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   2: ADC0_DP2             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   3: ADC0_DP3             = ADC1_DP0(p11)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
      };
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  PinIndex                PCR value
            /*   0: ADC0_DM0             = ADC0_DM0(p10)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
            /*   1: ADC0_DM1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   2: ADC0_DM2             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   3: ADC0_DM3             = ADC1_DM0(p12)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
      };
...
public:
   ...
   /**
    * Disables the clock to Adc1 and all mapped pins
    */
   static void disable() {
      adc->SC1[0] = ADC_SC1_ADCH(-1);
      disableAllPins();
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: ADC1_SE0             = ADC1_DP0(p11)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: ADC1_SE1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   2: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*   3: ADC1_SE3             = ADC0_DP0(p9)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         ...
         /*   8: ADC1_SE8             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   9: ADC1_SE9             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  10: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*  11: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         ...
         /*  18: ADC1_SE18            = VREF_OUT(p17)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  19: ADC1_SE19            = ADC1_DM0(p12)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  PinIndex                PCR value
            /*   0: ADC1_DP0             = ADC1_DP0(p11)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
            /*   1: ADC1_DP1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   2: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
            /*   3: ADC1_DP3             = ADC0_DP0(p9)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
      };
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  PinIndex                PCR value
            /*   0: ADC1_DM0             = ADC1_DM0(p12)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
            /*   1: ADC1_DM1             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
            /*   2: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
            /*   3: ADC1_DM3             = ADC0_DM0(p10)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
      };
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            /*   7: ADC1_SE7b            = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
      };
...
public:
    ...
    */
   typedef void (*CallbackFunction)(const CmpStatus &status);
   
   /**
    * Callback to catch unhandled interrupt
    */
   static void unhandledCallback(const CmpStatus &) {
      setAndCheckErrorCode(E_NO_HANDLER);
   }
   
   /**
    * Class used to do initialisation of the Cmp
    *
    * This class has a templated constructor that accepts various values.
    * Parameters available may vary with device - see Cmp0::DefaultInitValue for relevant example.
    * Omitted parameters default to zero (disabled) or unchanged if initialiser is provided as last parameter.
    *
    * @note This constructor may be used to create a const instance in Flash
    *
    ...
    * /// @param status  Status reflecting active inputs
    * ///
    * void cmp0Callback(uint32_t status) {
    *    (void) status;
    * }
    *
    * static const Cmp0::Init cmp0Init {
    *
    *   // General setup
    ...
    *
    *   cmp0Callback,                // Call-back to execute on event - call-back function name
    *   NvicPriority_Low,                // Priority for interrupt - Low
    *
    *   // Optional base value to start with (must be last parameter)
    *   Cmp0::DefaultInitValue   // Used as base value modified by above
    * };
    *
    * // Initialise Cmp0 from values specified above
    * Cmp0::configure(cmp0Init)
    * @endcode
    */
   class Init {
   ...
   public:
      ...
      /// IRQ priority levels and IRQ level for this peripheral
      NvicPriority irqlevel = NvicPriority_NotInstalled;
       ...
       */
      template <typename... Types>
      constexpr Init(CmpInputPlus cmpInputPlus, Types... rest) : Init(rest...) {
   
         muxcr = (muxcr&~CMP_MUXCR_PSEL_MASK) | cmpInputPlus;
      }
       ...
       */
      template <typename... Types>
      constexpr Init(CmpInputMinus cmpInputMinus, Types... rest) : Init(rest...) {
   
         muxcr = (muxcr&~CMP_MUXCR_MSEL_MASK) | cmpInputMinus;
      }
   
      /**
       * Constructor for Filter Sample Count and Filter Sample Period in ticks
       *
       * @tparam   Types
       * @param    rest
       *
      ...
      /**
       * Constructor for DAC Enable, DAC Reference Voltage Select and DAC level
       *
       * @tparam   Types
       * @param    rest
       *
...
public:
   ...
   /**
    * Disables the clock to Cmp0 and all mapped pins
    */
   static void disable() {
    ...
    *
    * @param[in]  cmpCallback Callback function to execute on interrupt
    *                             Use nullptr to remove callback.
    */
   static void setCallback(CallbackFunction cmpCallback) {
      if (cmpCallback == nullptr) {
         cmpCallback = unhandledCallback;
      }
      // Allow either no handler set yet or removing handler
      usbdm_assert(
            (sCallback == unhandledCallback) || (cmpCallback == unhandledCallback),
            "Handler already set");
      sCallback = cmpCallback;
   }
   
   /**
    * CMP interrupt handler -  Calls CMP callback
    */
   static void irqHandler() {
      ...
      CmpStatus cmpStatus {
         // Extract status bits
         CmpEventId(status&(CMP_SCR_CFR_MASK|CMP_SCR_CFF_MASK)),
   ...
   /**
    * Default initialisation value for Cmp0
    * This value is created from Configure.usbdmProject settings
    */
   static constexpr Init DefaultInitValue = {
      CmpEnable_Disabled , // (cmp_cr1_en) Comparator Enable - Comparator is disabled
      CmpMode_Direct , // (cmp_cr1_mode) Operating mode - Direct
      CmpTrigger_Disabled , // (cmp_cr1_trigm) Trigger Mode Enable - Trigger mode is disabled
      CmpPower_LowSpeed , // (cmp_cr1_pmode) Power Mode Select - Low-Speed Comparison mode
      CmpPolarity_Normal , // (cmp_cr1_inv) Comparator Invert - Not inverted
      CmpOutput_Disabled , // (cmp_cr1_output) Comparator output pin source - Disabled
      CmpHysteresis_Level_3 , // (cmp_cr0_hystctr) Comparator hard block hysteresis control - Level 3
      CmpDma_Disabled , // (cmp_scr_dmaen) DMA Enable Control - Disabled
      CmpEvent_Disabled , // (cmp_scr_interrupt) Action on transition - Disabled
      CmpFilterSamples_Bypassed , // (cmp_cr0_filter) Filter Sample Count - Disabled
      0_ticks , // (cmp_fpr_filt_per) Filter Sample Period in ticks
      CmpDacEnable_Disabled , // (cmp_daccr_dacen) DAC Enable - Disabled
      CmpDacrefSel_VrefOut , // (cmp_daccr_vrsel) DAC Reference Voltage Select - Vin1 (Vref_OUT)
      uint8_t(31) , // (cmp_daccr_vosel) DAC level
      CmpInputPlus_0 , // (cmp_muxcr_psel0) Plus Input Mux Control - CMP_IN0
      CmpInputMinus_0,  // (cmp_muxcr_msel0) Minus Input Mux Control - CMP_IN0
   };
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: CMP0_IN1             = PTC7(p52)                      */  { PinIndex::PTC7,         PcrValue(0x08000UL) },
         ...
         /*   5: CMP0_IN5             = VREF_OUT(p17)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
...
public:
   ...
   /**
    * Default initialisation value for Cmp1
    * This value is created from Configure.usbdmProject settings
    */
   static constexpr Init DefaultInitValue = {
      CmpEnable_Disabled , // (cmp_cr1_en) Comparator Enable - Comparator is disabled
      ...
      CmpPolarity_Normal , // (cmp_cr1_inv) Comparator Invert - Not inverted
      CmpOutput_Disabled , // (cmp_cr1_output) Comparator output pin source - Disabled
      CmpHysteresis_Level_0 , // (cmp_cr0_hystctr) Comparator hard block hysteresis control - Level 0
      CmpDma_Disabled , // (cmp_scr_dmaen) DMA Enable Control - Disabled
      CmpEvent_Disabled , // (cmp_scr_interrupt) Action on transition - Disabled
      CmpFilterSamples_Bypassed , // (cmp_cr0_filter) Filter Sample Count - Disabled
      0_ticks , // (cmp_fpr_filt_per) Filter Sample Period in ticks
      ...
      CmpDacrefSel_VrefOut , // (cmp_daccr_vrsel) DAC Reference Voltage Select - Vin1 (Vref_OUT)
      uint8_t(31) , // (cmp_daccr_vosel) DAC level
      CmpInputPlus_0 , // (cmp_muxcr_psel1) Plus Input Mux Control - CMP_IN0
      CmpInputMinus_0,  // (cmp_muxcr_msel1) Minus Input Mux Control - CMP_IN0
   };
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: CMP1_IN3             = DAC0_OUT(p18)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   4: --                   = --                             */  { PinIndex::INVALID_PCR,  PcrValue(0)         },
         /*   5: CMP1_IN5             = VREF_OUT(p17)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
...
using SWD_DIO_pin          = PcrTable_T<ControlInfo, 7>;
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: RESET_b              = RESET_b(p34)                   */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: JTAG_TCLK            = PTA0(p22)                      */  { PinIndex::PTA0,         PcrValue(0x08700UL) },
         /*   2: SWD_CLK              = PTA0(p22)                      */  { PinIndex::PTA0,         PcrValue(0x08700UL) },
         ...
         /*   6: JTAG_TMS             = PTA3(p25)                      */  { PinIndex::PTA3,         PcrValue(0x08700UL) },
         /*   7: SWD_DIO              = PTA3(p25)                      */  { PinIndex::PTA3,         PcrValue(0x08700UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: DAC0_OUT             = DAC0_OUT(p18)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
   };
...
public:
   ...
   /**
    * Class used to do initialisation of the Ftm
    *
    * This class has a templated constructor that accepts various values:
    *
    * @note This constructor may be used to create a const instance in ROM
    ...
    *
    *    ftm0Callback,              // Call-back to execute on event - call-back function name
    *    NvicPriority_Low,              // Priority for interrupt - Low
    *
    *    // Optional base value to start with (must be last parameter)
    *    Ftm0::DefaultValue
    * };
    *
    * // Initialise Ftm0 from values specified above
   ...
   public:
      ...
      // Channel Output Polarity (ftm_pol_pol)
      uint16_t pol = 0;

      // End value for counter (ftm_mod_mod)
      uint16_t mod = 0;

      // Period or minimum interval of timer (ftm_modPeriod)
      Seconds modperiod = 0_s;

      // PWM Synchronisation Mode (ftm_mode_pwmsync)
      // Write Protection Disable (ftm_mode_wpdis)
      // FTM Mode Enable (ftm_mode_ftmen)
      uint8_t mode = 0;

      // Dead-time Prescaler Value (ftm_deadtime_dtps)
      // Dead-time Value (ftm_deadtime_dtval)
      uint8_t deadtime = 0;

      // External Trigger Enable (ftm_exttrig_trig)
      uint8_t exttrig = 0;

      // Action on Counter overflow (ftm_sc_action)
      // Counting mode (ftm_sc_cpwms)
      // Clock Source (ftm_sc_clks)
      // Counter clock prescaler (ftm_sc_ps)
      uint8_t sc = 0;

      // Global Time Base Output (ftm_conf_gtbeout)
      // External Global Time Base Enable (ftm_conf_gtbeen)
      // Behaviour in BDM Mode (ftm_conf_bdmmode)
      // TOF Frequency (ftm_conf_numtof)
      uint16_t conf = 0;

      /**
       * Constructor for Channel Output Polarity
       * (ftm_pol_pol)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmPolarity Bitmask defining the active-low channel outputs (1=ActiveLow).
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr Init(FtmPolarity ftmPolarity, Types... rest) : Init(rest...) {
   
         // Modify bit
         pol = (pol&(ftmPolarity>>8))|ftmPolarity;
      }
   
      /**
       * Constructor for External Trigger Enable
       * (ftm_exttrig_trig)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmExternalTrigger Bitmask enabling generation of the external trigger when the FTM
       *        counter is equal to a channel CnV register or CNTIN
       */
      template <typename... Types>
      constexpr Init(FtmExternalTrigger ftmExternalTrigger, Types... rest) : Init(rest...) {
   
         // Modify bit
         exttrig = (exttrig&(ftmExternalTrigger>>8))|ftmExternalTrigger;
      }
       ...
       */
      template <typename... Types>
      constexpr Init(FtmCountMode ftmCountMode, Types... rest) : Init(rest...) {
   
         sc = (sc&~FTM_SC_CPWMS_MASK) | ftmCountMode;
      }
      ...
      /**
       * Constructor for PWM Synchronisation Mode
       * (ftm_mode_pwmsync)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmPwmSyncMode Selects which triggers can be used by MOD, CnV, OUTMASK, and FTM
       *        counter synchronisation.
       *        Only available in legacy PWM synchronisation (SYNCMODE = 0).
       */
      template <typename... Types>
      constexpr Init(FtmPwmSyncMode ftmPwmSyncMode, Types... rest) : Init(rest...) {
   
         mode = (mode&~FTM_MODE_PWMSYNC_MASK) | ftmPwmSyncMode;
      }
   
      /**
       * Constructor for Write Protection Disable
       * (ftm_mode_wpdis)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmWriteProtect This value is applied after main FTM configuration
       */
      template <typename... Types>
      constexpr Init(FtmWriteProtect ftmWriteProtect, Types... rest) : Init(rest...) {
   
         mode = (mode&~FTM_MODE_WPDIS_MASK) | ftmWriteProtect;
      }
   
      /**
       * Constructor for FTM Mode Enable
       * (ftm_mode_ftmen)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmRegisterSet This field is write protected. It can be written only when MODE[WPDIS] = 1
       */
      template <typename... Types>
      constexpr Init(FtmRegisterSet ftmRegisterSet, Types... rest) : Init(rest...) {
   
         mode = (mode&~FTM_MODE_FTMEN_MASK) | ftmRegisterSet;
      }
   
      /**
       * Constructor for Global Time Base Output
       * (ftm_conf_gtbeout)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmGlobalTimebaseOutput Enables the global time base signal generation to other FTMs
       */
      template <typename... Types>
      constexpr Init(FtmGlobalTimebaseOutput ftmGlobalTimebaseOutput, Types... rest) : Init(rest...) {
   
         conf = (conf&~FTM_CONF_GTBEOUT_MASK) | ftmGlobalTimebaseOutput;
      }
   
      /**
       * Constructor for External Global Time Base Enable
       * (ftm_conf_gtbeen)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmGlobalExternalTimebase Configures the FTM to use an external global time base signal that is generated by another FTM.
       */
      template <typename... Types>
      constexpr Init(FtmGlobalExternalTimebase ftmGlobalExternalTimebase, Types... rest) : Init(rest...) {
   
         conf = (conf&~FTM_CONF_GTBEEN_MASK) | ftmGlobalExternalTimebase;
      }
   
      /**
       * Constructor for Behaviour in BDM Mode
       * (ftm_conf_bdmmode)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmBdmmode Selects the FTM behavior in Debug mode.
       */
      template <typename... Types>
      constexpr Init(FtmBdmmode ftmBdmmode, Types... rest) : Init(rest...) {
   
         conf = (conf&~FTM_CONF_BDMMODE_MASK) | ftmBdmmode;
      }
   
      /**
       * Constructor for TOF Frequency
       * (ftm_conf_numtof)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmOverflowDivider Selects the ratio between counter overflows and the number of times the TOF bit is set.
       *        The TOF is set for the 1st overflow and then ignored for N further overflows.
       */
      template <typename... Types>
      constexpr Init(FtmOverflowDivider ftmOverflowDivider, Types... rest) : Init(rest...) {
   
         conf = (conf&~FTM_CONF_NUMTOF_MASK) | FTM_CONF_NUMTOF(ftmOverflowDivider);
      }
   
      /**
       * Constructor for Dead-time Prescaler Value and Dead-time Value
       * (ftm_deadtime_dtps,ftm_deadtime_dtval)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmDeadtimePrescale Scale value for dead-time
       * @param ticks               This tick value is scaled by the dead-time prescaler
       */
      template <typename... Types>
      constexpr Init(
            FtmDeadtimePrescale ftmDeadtimePrescale,
            const Ticks&        ticks, Types... rest) : Init(rest...) {
   
         deadtime = (deadtime&~(FTM_DEADTIME_DTPS_MASK|FTM_DEADTIME_DTVAL_MASK)) | ftmDeadtimePrescale|FTM_DEADTIME_DTVAL(ticks);
      }
   
      /**
       * Constructor for Counter clock prescaler and End value for counter
       *
       * @tparam   Types
       * @param    rest
       *
      ...
      constexpr Init(
            ...
            const Ticks& mod_ticks, Types... rest) : Init(rest...) {
       ...
       */
      template <typename... Types>
      constexpr Init(const Seconds& seconds, Types... rest) : Init(rest...) {
   
         mod   = 0;
         modperiod = seconds;
      }
   
   }; // class FtmBasicInfo::Init

   /**
    * Class used to do initialisation of FtmChannel
    *
    * This class has a templated constructor that accepts various values:
    *
    * @note This constructor may be used to create a const instance in ROM
   ...
   public:
      ...
      // Output Compare Event time in ticks (ftm_cnv_independent[0])
      uint16_t cnv = 0;

      // Channel Mode (ftm_cnsc_mode_independent[0])
      // Action on Channel Event (ftm_cnsc_action_independent[0])
      // Reset counter on channel IC event (ftm_cnsc_icrst_independent[0])
      uint8_t cnsc = 0;

      // Channel Number (ftm_channel_number)
      FtmChannelNum channel = FtmChannelNum_None;

      // Channel Input Filter (ftm_filter_fval_independent[0])
      uint8_t filter = FtmInputFilter_Disabled;
      ...
      constexpr ChannelInit(FtmChannelMode ftmChannelMode, Types... rest) : ChannelInit(rest...) {
         ...
         cnsc = (cnsc&~(FTM_CnSC_MS_MASK|FTM_CnSC_ELS_MASK)) | ftmChannelMode;
      }
       ...
       * @param    rest
       *
       * @param ftmChannelReset FTM counter reset is driven by the selected event of the channel
       *        in the Input Capture mode.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      ...
      /**
       * Constructor for Channel Input Filter
       * (ftm_filter_fval_independent[])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmInputFilter Selects the filter value for the channel input
       */
      template <typename... Types>
      constexpr ChannelInit(FtmInputFilter ftmInputFilter, Types... rest) : ChannelInit(rest...) {
   
         filter = ftmInputFilter;
      }
       ...
       * @param    rest
       *
       * @param ticks This value is compared against the main counter
       */
      template <typename... Types>
   ...
   }; // class  FtmBasicInfo::ChannelInit

   /**
    * Class used to do initialisation of a pair of FtmChannels operating in Paired mode
    *
    * This class has a templated constructor that accepts various values:
    *
    * @note This constructor may be used to create a const instance in ROM
    ...
    * Example:
    * @code
    * static const Ftm0::DualChannelInit channelInit {
    *
    *    // Omitted parameters are taken to be zero unless a base value is given
   ...
   public:
      ...
      // Even channel O/C Event time in ticks (ftm_cnv_paired[0])
      // Odd channel O/C Event time in ticks (ftm_cnv_paired[1])
      uint16_t cnv[2] = {0,0};

      // Paired Channels Mode (ftm_cnsc_mode_even[0])
      // Odd channel Capture Polarity (ftm_cnsc_secondEdge[1])
      // Odd channel Output Control (ftm_cnsc_secondOutput[1])
      uint8_t cnsc[2] = {0,0};

      // Action on Odd channel (Ch1) event (ftm_combine_decap0)
      // Paired Channels Complementary Enable (ftm_combine_comp0)
      // Paired Channels Fault Control Enable (ftm_combine_faulten0)
      // Paired Channels Deadtime Enable (ftm_combine_dten0)
      uint8_t combine = 0;

      // Channel Number (ftm_channel_number)
      FtmChannelNum channel = FtmChannelNum_None;

      // Even Channel Input Filter (ftm_filter_fval_paired[0])
      // Odd Channel Input Filter (ftm_filter_fval_paired[1])
      uint8_t filter = FtmInputFilter_Disabled;

      /**
       * Constructor for Paired Channels Mode
       * (/FTM0/ftm_cnsc_mode_even[0])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmEvenChannelMode Determines channel operation (Combined PWM or Dual-edge capture)
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmEvenChannelMode ftmEvenChannelMode, Types... rest) : DualChannelInit(rest...) {
   
         cnsc[0] = ftmEvenChannelMode;
   
         // ftmEvenChannelMode also includes COMBINEx and DECAPENx
       ...
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmChannelNum ftmChannelNum, Types... rest) : DualChannelInit(rest...) {
   
         channel = ftmChannelNum;
      }
   
      /**
       * Constructor for Odd channel mode
       * (ftm_cnsc_mode_odd[1])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmOddChannelMode Behaviour of second channel when channels are paired
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmOddChannelMode ftmOddChannelMode, Types... rest) : DualChannelInit(rest...) {
   
         cnsc[1] = ftmOddChannelMode;
      }
   
      /**
       * Constructor for Action on Even Channel Event and Action on Odd Channel Event
       * (ftm_cnsc_action_paired[0],ftm_cnsc_action_paired[1])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param actionEven       Enable interrupt or DMA on channel event
       * @param actionOdd        Enable interrupt or DMA on channel event
       */
      template <typename... Types>
      constexpr DualChannelInit(
            FtmChannelAction actionEven,
            FtmChannelAction actionOdd, Types... rest) : DualChannelInit(rest...) {
   
         cnsc[0]    = (cnsc[0]&~(FTM_CnSC_CHIE_MASK|FTM_CnSC_DMA_MASK)) | actionEven;
         cnsc[1]    = (cnsc[1]&~(FTM_CnSC_CHIE_MASK|FTM_CnSC_DMA_MASK)) | actionOdd;
      }
   
      /**
       * Constructor for Even channel O/C Event time in ticks and Odd channel O/C Event time in ticks
       * (ftm_cnv_paired[0],ftm_cnv_paired[1])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param eventTimeEven This value is compared against the main counter
       * @param eventTimeOdd This value is compared against the main counter
       */
      template <typename... Types>
      constexpr DualChannelInit(
            const Ticks& eventTimeEven,
            const Ticks& eventTimeOdd, Types... rest) : DualChannelInit(rest...) {
      ...
      /**
       * Constructor for Even Channel Input Filter and Odd Channel Input Filter
       * (/FTM0/ftm_filter_fval_paired[0])
       *
       * @tparam   Types
       * @param    rest
       *
       * @param filterEven     Selects the filter value for the channel input
       * @param filterOdd      Selects the filter value for the channel input
       */
      template <typename... Types>
      constexpr DualChannelInit(
            FtmInputFilter filterEven,
            FtmInputFilter filterOdd, Types... rest) : DualChannelInit(rest...) {
   
         filter = filterEven | (filterOdd<<4);
      }
   
      /**
       * Constructor for Action on Odd channel (Ch1) event
       * (ftm_combine_decap0)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSecondEventAction Enables the capture of the FTM counter value on odd channel events.
       *        In dual edge capture one-shot mode, this bit is cleared automatically by hardware when the capture occurs.
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmSecondEventAction ftmSecondEventAction, Types... rest) : DualChannelInit(rest...) {
   
         combine = (combine&~FTM_COMBINE_DECAP0_MASK) | ftmSecondEventAction;
      }
   
      /**
       * Constructor for Paired Channels Complementary Enable
       * (ftm_combine_comp0)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmComplementChannel Enables Complementary mode for the paired channels.
       *        In Complementary mode the channel (n+1) output is the inverse of the channel (n) output.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmComplementChannel ftmComplementChannel, Types... rest) : DualChannelInit(rest...) {
   
         combine = (combine&~FTM_COMBINE_COMP0_MASK) | ftmComplementChannel;
      }
   
      /**
       * Constructor for Paired Channels Fault Control Enable
       * (ftm_combine_faulten0)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFaultControl Enables the fault control of the channel pair.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmFaultControl ftmFaultControl, Types... rest) : DualChannelInit(rest...) {
   
         combine = (combine&~FTM_COMBINE_FAULTEN0_MASK) | ftmFaultControl;
      }
   
      /**
       * Constructor for Paired Channels Deadtime Enable
       * (ftm_combine_dten0)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmDeadtime Enables the deadtime insertion in the channels (n) and (n+1).
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmDeadtime ftmDeadtime, Types... rest) : DualChannelInit(rest...) {
   
         combine = (combine&~FTM_COMBINE_DTEN0_MASK) | ftmDeadtime;
      }
   
      /**
       * Constructor for Paired Channels Synchronization Enable
       * (ftm_combine_syncen0)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSyncEnable Enables PWM synchronization of registers C(n)V and C(n+1)V.
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmSyncEnable ftmSyncEnable, Types... rest) : DualChannelInit(rest...) {
   
         combine = (combine&~FTM_COMBINE_SYNCEN0_MASK) | ftmSyncEnable;
      }
   
      /**
       * Constructor for Reset counter on 2nd IC event
       * (ftm_cnsc_icrst_paired[1])
       *
       * @tparam   Types
       * @param    rest
       *
       ...
       */
      template <typename... Types>
      constexpr DualChannelInit(FtmChannelReset ftmChannelReset, Types... rest) : DualChannelInit(rest...) {
   
         cnsc[1] = (cnsc[1]&~FTM_CnSC_ICRST_MASK) | ftmChannelReset;
      }
   
   }; // class  FtmBasicInfo::DualChannelInit

   /**
    * Class used to do initialisation of the Ftm Trigger settings
    *
    * This class has a templated constructor that accepts various values:
    *
    * @note This constructor may be used to create a const instance in ROM
    ...
    *
    * @code
    * static const Ftm0::SyncInit FtmSyncInit {
    *
    *    // Omitted parameters are taken to be zero unless a base value is given
   ...
   public:
      ...
      // Minimum Loading Point Enable (ftm_sync_cntmin)
      // Maximum Loading Point Enable (ftm_sync_cntmax)
      // Counter Reinitialisation (ftm_sync_reinit)
      // Hardware Trigger Inputs (ftm_sync_trig)
      // OUTMASK Register Synchronisation (ftm_sync_synchom)
      uint8_t sync = 0;

      // Synchronisation Mode (ftm_synconf_syncmode)
      // Hardware Trigger Clearing (ftm_synconf_hwtrigmode)
      // CNTIN Register Synchronisation (ftm_synconf_cntinc)
      // CNTIN/MOD/CV Software Synchronisation (ftm_synconf_swwrbuf)
      // CNTIN/MOD/CV Hardware Synchronisation (ftm_synconf_hwwrbuf)
      // OUTMASK Software Synchronisation (ftm_synconf_swom)
      // OUTMASK Hardware Synchronisation (ftm_synconf_hwom)
      // INVCTRL Register Synchronisation (ftm_synconf_invc)
      // INVCTRL Software Synchronisation (ftm_synconf_swinvc)
      // INVCTRL Hardware Synchronisation (ftm_synconf_hwinvc)
      // SWOCTRL Register Synchronisation (ftm_synconf_swoc)
      // CNT Hardware Synchronisation (ftm_synconf_hwrstcnt)
      uint32_t synconf = 0;

      /**
       * Constructor for Minimum Loading Point Enable
       * (ftm_sync_cntmin)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSyncCntmin Selects the minimum loading point for loading of MOD/CNTIN/CnV from buffers.
       *        If enabled, the loading occurs when the FTM counter reaches CNTIN.
       */
      template <typename... Types>
      constexpr SyncInit(FtmSyncCntmin ftmSyncCntmin, Types... rest) : SyncInit(rest...) {
   
         sync = (sync&~FTM_SYNC_CNTMIN_MASK) | ftmSyncCntmin;
      }
   
      /**
       * Constructor for Maximum Loading Point Enable
       * (ftm_sync_cntmax)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSyncCntmax Selects the maximum loading point for loading of MOD/CNTIN/CnV from buffers.
       *        If enabled, the loading occurs when the FTM counter reaches MOD.
       */
      template <typename... Types>
      constexpr SyncInit(FtmSyncCntmax ftmSyncCntmax, Types... rest) : SyncInit(rest...) {
   
         sync = (sync&~FTM_SYNC_CNTMAX_MASK) | ftmSyncCntmax;
      }
   
      /**
       * Constructor for Counter Reinitialisation
       * (ftm_sync_reinit)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmReinitOnSync Determines if the FTM counter is reinitialised when
       *        the selected synchronisation trigger is detected.
       *        Only available in legacy PWM synchronisation (SYNCMODE = 0).
       */
      template <typename... Types>
      constexpr SyncInit(FtmReinitOnSync ftmReinitOnSync, Types... rest) : SyncInit(rest...) {
   
         sync = (sync&~FTM_SYNC_REINIT_MASK) | ftmReinitOnSync;
      }
   
      /**
       * Constructor for OUTMASK Register Synchronisation
       * (ftm_sync_synchom)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSyncSynchom Selects when the OUTMASK register is updated with the value of its buffer
       */
      template <typename... Types>
      constexpr SyncInit(FtmSyncSynchom ftmSyncSynchom, Types... rest) : SyncInit(rest...) {
   
         sync = (sync&~FTM_SYNC_SYNCHOM_MASK) | ftmSyncSynchom;
      }
   
      /**
       * Constructor for Hardware Trigger Clearing
       * (ftm_synconf_hwtrigmode)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmTriggerClear Controls when hardware triggers are cleared
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmTriggerClear ftmTriggerClear, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWTRIGMODE_MASK) | ftmTriggerClear;
      }
   
      /**
       * Constructor for Synchronisation Mode
       * (ftm_synconf_syncmode)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSyncPwm Selects the PWM synchronisation mode
       */
      template <typename... Types>
      constexpr SyncInit(FtmSyncPwm ftmSyncPwm, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SYNCMODE_MASK) | ftmSyncPwm;
      }
   
      /**
       * Constructor for CNTIN Register Synchronisation
       * (ftm_synconf_cntinc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmBufferSyncCounter CNTIN Register Synchronisation with buffer
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmBufferSyncCounter ftmBufferSyncCounter, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_CNTINC_MASK) | ftmBufferSyncCounter;
      }
   
      /**
       * Constructor for CNTIN/MOD/CV Software Synchronisation
       * (ftm_synconf_swwrbuf)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSwSyncRegs Controls MOD/CNTIN/CV synchronisation by software trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmSwSyncRegs ftmSwSyncRegs, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SWWRBUF_MASK) | ftmSwSyncRegs;
      }
   
      /**
       * Constructor for CNTIN/MOD/CV Hardware Synchronisation
       * (ftm_synconf_hwwrbuf)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHwSyncRegs Controls MOD/CNTIN/CV synchronisation by hardware trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmHwSyncRegs ftmHwSyncRegs, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWWRBUF_MASK) | ftmHwSyncRegs;
      }
   
      /**
       * Constructor for OUTMASK Software Synchronisation
       * (ftm_synconf_swom)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSwSyncOutmask Controls OUTMASK synchronisation by software trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmSwSyncOutmask ftmSwSyncOutmask, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SWOM_MASK) | ftmSwSyncOutmask;
      }
   
      /**
       * Constructor for OUTMASK Hardware Synchronisation
       * (ftm_synconf_hwom)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHwSyncOutmask Controls OUTMASK synchronisation by hardware trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmHwSyncOutmask ftmHwSyncOutmask, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWOM_MASK) | ftmHwSyncOutmask;
      }
   
      /**
       * Constructor for INVCTRL Register Synchronisation
       * (ftm_synconf_invc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmBufferSyncInvctrl Controls INVCTRL Register Synchronisation with buffer
       */
      template <typename... Types>
      constexpr SyncInit(FtmBufferSyncInvctrl ftmBufferSyncInvctrl, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_INVC_MASK) | ftmBufferSyncInvctrl;
      }
   
      /**
       * Constructor for INVCTRL Software Synchronisation
       * (ftm_synconf_swinvc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSwSyncInvCtrl Controls INVCTRL synchronisation by software trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmSwSyncInvCtrl ftmSwSyncInvCtrl, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SWINVC_MASK) | ftmSwSyncInvCtrl;
      }
   
      /**
       * Constructor for INVCTRL Hardware Synchronisation
       * (ftm_synconf_hwinvc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHwSyncInvctrl Controls INVCTRL synchronisation by hardware trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmHwSyncInvctrl ftmHwSyncInvctrl, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWINVC_MASK) | ftmHwSyncInvctrl;
      }
   
      /**
       * Constructor for SWOCTRL Register Synchronisation
       * (ftm_synconf_swoc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmBufferSyncSwoctrl Controls SWOCTRL Register Synchronisation with buffer
       */
      template <typename... Types>
      constexpr SyncInit(FtmBufferSyncSwoctrl ftmBufferSyncSwoctrl, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SWOC_MASK) | ftmBufferSyncSwoctrl;
      }
   
      /**
       * Constructor for SWOCTRL Hardware Synchronisation
       * (ftm_synconf_hwsoc)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHwSyncSwoctrl Controls SWOCTRL synchronisation by hardware trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmHwSyncSwoctrl ftmHwSyncSwoctrl, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWSOC_MASK) | ftmHwSyncSwoctrl;
      }
   
      /**
       * Constructor for CNT Software Synchronisation
       * (ftm_synconf_swrstcnt)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmSwSyncCounter Controls counter synchronisation by software trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmSwSyncCounter ftmSwSyncCounter, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_SWRSTCNT_MASK) | ftmSwSyncCounter;
      }
   
      /**
       * Constructor for CNT Hardware Synchronisation
       * (ftm_synconf_hwrstcnt)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHwSyncCounter Controls Counter synchronisation by hardware trigger
       *        Only available in enhanced PWM synchronisation (SYNCMODE = 1).
       */
      template <typename... Types>
      constexpr SyncInit(FtmHwSyncCounter ftmHwSyncCounter, Types... rest) : SyncInit(rest...) {
   
         synconf = (synconf&~FTM_SYNCONF_HWRSTCNT_MASK) | ftmHwSyncCounter;
      }
   
      /**
       * Constructor for Hardware Trigger Inputs
       * (ftm_sync_trig)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmHardwareTrigger Enables hardware trigger to the PWM synchronisation.
       *        Hardware trigger occurs on a rising edge of the corresponding trigger input signal.
       */
      template <typename... Types>
      constexpr SyncInit(FtmHardwareTrigger ftmHardwareTrigger, Types... rest) : SyncInit(rest...) {
   
         sync |= ftmHardwareTrigger;
      }
   
   }; // class FtmBasicInfo::SyncInit

   /**
    * Class used to do initialisation of Ftm Fault handling
    *
    * This class has a templated constructor that accepts various values:
    *
    * @note This constructor may be used to create a const instance in ROM
    ...
    * Example:
    * @code
    * static const Ftm0::FaultInit faultInit {
    *
    *    // Omitted parameters are taken to be zero unless a base value is given
    ...
    *    Ftm0::DefaultFaultInitValue
    * };
    *
    * // Initialise FTM0 from values specified above
    * Ftm0::configureFaultHandling(faultInit)
    * @endcode
    */
   class FaultInit {
   ...
   public:
      ...
      // Fault Control Mode (ftm_mode_faultm)
      // Action on Fault event (ftm_mode_faultie)
      uint8_t mode = 0;

      // Fault Input Filter (ftm_fltctrl_ffval)
      // Fault Input 0 (FTM0_FLT0/CMP0) (ftm_fltctrl_fault0en)
      // Fault Input 1 (FTM0_FLT1/CMP1) (ftm_fltctrl_fault1en)
      // Fault Input 2 (FTM0_FLT2) (ftm_fltctrl_fault2en)
      // Fault Input 3 (FTM0_FLT3) (ftm_fltctrl_fault3en)
      uint16_t fltctrl = 0;

      // Fault Input 0 Polarity (ftm_fltpol_flt0pol)
      // Fault Input 1 Polarity (ftm_fltpol_flt1pol)
      // Fault Input 2 Polarity (ftm_fltpol_flt2pol)
      // Fault Input 3 Polarity (ftm_fltpol_flt3pol)
      uint8_t fltpol = 0;

      /**
       * Constructor for Fault Control Mode
       * (ftm_mode_faultm)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFaultMode This is a write-once after reset setting
       */
      template <typename... Types>
      constexpr FaultInit(FtmFaultMode ftmFaultMode, Types... rest) : FaultInit(rest...) {
   
         mode = (mode&~FTM_MODE_FAULTM_MASK) | ftmFaultMode;
      }
   
      /**
       * Constructor for Action on Fault event
       * (ftm_mode_faultie)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFaultAction 
       */
      template <typename... Types>
      constexpr FaultInit(FtmFaultAction ftmFaultAction, Types... rest) : FaultInit(rest...) {
   
         mode = (mode&~FTM_MODE_FAULTIE_MASK) | ftmFaultAction;
      }
   
      /**
       * Constructor for Fault Input Filter
       * (ftm_fltctrl_ffval)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFaultFilter Selects the filter value for the fault inputs.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFaultFilter ftmFaultFilter, Types... rest) : FaultInit(rest...) {
   
         fltctrl = (fltctrl&~FTM_FLTCTRL_FFVAL_MASK) | ftmFaultFilter;
      }
   
      /**
       * Constructor for Fault Input 0 (FTM0_FLT0/CMP0)
       * (ftm_fltctrl_fault0en)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault0Mode Enables the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault0Mode ftmFault0Mode, Types... rest) : FaultInit(rest...) {
   
         fltctrl = (fltctrl&~(FTM_FLTCTRL_FAULT0EN_MASK|FTM_FLTCTRL_FFLTR0EN_MASK)) | ftmFault0Mode;
      }
   
      /**
       * Constructor for Fault Input 1 (FTM0_FLT1/CMP1)
       * (ftm_fltctrl_fault1en)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault1Mode Enables the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault1Mode ftmFault1Mode, Types... rest) : FaultInit(rest...) {
   
         fltctrl = (fltctrl&~(FTM_FLTCTRL_FAULT1EN_MASK|FTM_FLTCTRL_FFLTR1EN_MASK)) | ftmFault1Mode;
      }
   
      /**
       * Constructor for Fault Input 2 (FTM0_FLT2)
       * (ftm_fltctrl_fault2en)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault2Mode Enables the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault2Mode ftmFault2Mode, Types... rest) : FaultInit(rest...) {
   
         fltctrl = (fltctrl&~(FTM_FLTCTRL_FAULT2EN_MASK|FTM_FLTCTRL_FFLTR2EN_MASK)) | ftmFault2Mode;
      }
   
      /**
       * Constructor for Fault Input 3 (FTM0_FLT3)
       * (ftm_fltctrl_fault3en)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault3Mode Enables the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault3Mode ftmFault3Mode, Types... rest) : FaultInit(rest...) {
   
         fltctrl = (fltctrl&~(FTM_FLTCTRL_FAULT3EN_MASK|FTM_FLTCTRL_FFLTR3EN_MASK)) | ftmFault3Mode;
      }
   
      /**
       * Constructor for Fault Input 0 Polarity
       * (ftm_fltpol_flt0pol)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault0Polarity Defines the polarity of the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault0Polarity ftmFault0Polarity, Types... rest) : FaultInit(rest...) {
   
         fltpol = (fltpol&~FTM_FLTPOL_FLT0POL_MASK) | ftmFault0Polarity;
      }
   
      /**
       * Constructor for Fault Input 1 Polarity
       * (ftm_fltpol_flt1pol)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault1Polarity Defines the polarity of the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault1Polarity ftmFault1Polarity, Types... rest) : FaultInit(rest...) {
   
         fltpol = (fltpol&~FTM_FLTPOL_FLT1POL_MASK) | ftmFault1Polarity;
      }
   
      /**
       * Constructor for Fault Input 2 Polarity
       * (ftm_fltpol_flt2pol)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault2Polarity Defines the polarity of the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault2Polarity ftmFault2Polarity, Types... rest) : FaultInit(rest...) {
   
         fltpol = (fltpol&~FTM_FLTPOL_FLT2POL_MASK) | ftmFault2Polarity;
      }
   
      /**
       * Constructor for Fault Input 3 Polarity
       * (ftm_fltpol_flt3pol)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmFault3Polarity Defines the polarity of the fault input.
       *        This field is write protected. It can be written only when MODE[WPDIS] = 1.
       */
      template <typename... Types>
      constexpr FaultInit(FtmFault3Polarity ftmFault3Polarity, Types... rest) : FaultInit(rest...) {
   
         fltpol = (fltpol&~FTM_FLTPOL_FLT3POL_MASK) | ftmFault3Polarity;
      }
   
   }; // class  FtmBasicInfo::FaultInit
...
public:
   ...
   /**
    * Disables the clock to Ftm0 and all mapped pins
    */
   static void disable() {
...
public:
   ...
   static ErrorCode configure(const Init &init) {
      ...
      // Start value for counter (assumed always 0) (ftm_cntin)
      ftm->CNTIN=0;
   
      // End value for counter (ftm_mod_mod)
      ftm->MOD=mod;
   
      // Main counter (writing any value clears counter) (ftm_cnt_count)
      ftm->CNT=0;
    ...
    */
   static constexpr Init DefaultInitValue = {
      FtmOverflowAction_None , // (ftm_sc_action) Action on Counter overflow - No action
      ...
      FtmPrescale_DivBy1 , // (ftm_sc_ps) Counter clock prescaler - Divide by 1
      65535_ticks , // (ftm_mod_mod) End value for counter
      FtmFaultAction_Ignored , // (ftm_mode_faultie) Action on Fault event - No action
      FtmWriteProtect_Disabled , // (ftm_mode_wpdis) Write Protection Disable - Write protection is disabled
      FtmRegisterSet_AllRegisters , // (ftm_mode_ftmen) FTM Mode Enable - All registers available
      FtmPolarity(0x0) , // (ftm_pol_pol) Channel Output Polarity
      FtmDeadtimePrescale_DivideBy1 , // (ftm_deadtime_dtps) Dead-time Prescaler Value - Divide by 1
      0_ticks , // (ftm_deadtime_dtval) Dead-time Value
      FtmExternalTrigger(0x0) , // (ftm_exttrig_trig) External Trigger Enable
      FtmGlobalTimebaseOutput_Disabled , // (ftm_conf_gtbeout) Global Time Base Output - Disabled
      FtmGlobalExternalTimebase_Disabled , // (ftm_conf_gtbeen) External Global Time Base Enable - Disabled
      FtmBdmmode_Stopped_OutputsFunctional , // (ftm_conf_bdmmode) Behaviour in BDM Mode - Stopped, outputs functional
      FtmOverflowDivider(0),  // (ftm_conf_numtof) TOF Frequency

   //  ---Symbol not found or format incorrect for substitution  => key=/FTM0/irqHandlerName, def=null, mod=null
   };
   ...
   static ErrorCode configure(FtmChannelNum channelNum, const ChannelInit &init) {
      ...
      // Action on Channel Event (ftm_cnsc_action_independent[0])
      // Reset counter on channel IC event (ftm_cnsc_icrst_independent[0])
      ftm->CONTROLS[channelNum].CnSC = init.cnsc;
   
      // Output Compare Event time in ticks (ftm_cnv_independent[0])
      ftm->CONTROLS[channelNum].CnV = init.cnv;
   ...
   {
      FtmChannelNum_2, // and FtmChannelNum_3

      FtmEvenChannelMode_CombinePositivePulse,  // (ftm_cnsc_mode_even[2]) Paired Channels Mode - Combined PWM Positive-pulse
      FtmOddChannelMode_Disabled , // (ftm_cnsc_secondOutput[3]) Odd channel Output Control - Pin Disabled
      100_ticks , // (ftm_cnv_paired[2]) Even channel O/C Event time in ticks
      200_ticks , // (ftm_cnv_paired[3]) Odd channel O/C Event time in ticks
      FtmSecondEventAction_NoCapture , // (ftm_combine_decap1) Action on Odd channel (Ch3) event - NoCapture
      FtmComplementChannel_Normal , // (ftm_combine_comp1) Paired Channels Complementary Enable - Disabled
      FtmFaultControl_Normal , // (ftm_combine_faulten1) Paired Channels Fault Control Enable - Disabled
      FtmDeadtime_Disabled , // (ftm_combine_dten1) Paired Channels Deadtime Enable - Disabled
      FtmSyncEnable_Disabled,  // (ftm_combine_syncen1) Paired Channels Synchronization Enable - Disabled
      FtmChannelAction_None , // (ftm_cnsc_action_paired[2]) Action on Even Channel Event - No action
      FtmChannelAction_None,  // (ftm_cnsc_action_paired[3]) Action on Odd Channel Event - No action
   },
   {
      FtmChannelNum_4, // and FtmChannelNum_5

      FtmEvenChannelMode_DualEdgeCaptureOneShotFallingEdge,  // (ftm_cnsc_mode_even[4]) Paired Channels Mode - Dual-edge Capture One-Shot Falling-edge
      FtmOddChannelMode_Disabled , // (ftm_cnsc_secondEdge[5]) Odd channel Capture Polarity - Not used
      FtmChannelReset_Disabled,  // (ftm_cnsc_icrst_paired[5]) Reset counter on 2nd IC event - Disabled
      FtmChannelAction_None , // (ftm_cnsc_action_paired[4]) Action on Even Channel Event - No action
      FtmChannelAction_None,  // (ftm_cnsc_action_paired[5]) Action on Odd Channel Event - No action
   },
   {
      FtmChannelNum_6, // and FtmChannelNum_7

      FtmEvenChannelMode_CombineNegativePulse,  // (ftm_cnsc_mode_even[6]) Paired Channels Mode - Combine PWM Negative-pulse
      FtmOddChannelMode_Disabled , // (ftm_cnsc_secondOutput[7]) Odd channel Output Control - Pin Disabled
      0_ticks , // (ftm_cnv_paired[6]) Even channel O/C Event time in ticks
      0_ticks , // (ftm_cnv_paired[7]) Odd channel O/C Event time in ticks
      FtmSecondEventAction_NoCapture , // (ftm_combine_decap3) Action on Odd channel (Ch7) event - NoCapture
      FtmComplementChannel_Normal , // (ftm_combine_comp3) Paired Channels Complementary Enable - Disabled
      FtmFaultControl_Normal , // (ftm_combine_faulten3) Paired Channels Fault Control Enable - Disabled
      FtmDeadtime_Disabled , // (ftm_combine_dten3) Paired Channels Deadtime Enable - Disabled
      FtmSyncEnable_Disabled,  // (ftm_combine_syncen3) Paired Channels Synchronization Enable - Disabled
      FtmChannelAction_None , // (ftm_cnsc_action_paired[6]) Action on Even Channel Event - No action
      FtmChannelAction_None,  // (ftm_cnsc_action_paired[7]) Action on Odd Channel Event - No action
   },
   ...
   static ErrorCode configure(const SyncInit &init) {
      ...
      // INVCTRL Hardware Synchronisation (ftm_synconf_hwinvc)
      // SWOCTRL Register Synchronisation (ftm_synconf_swoc)
      // SWOCTRL Hardware Synchronisation (ftm_synconf_hwsoc)
      // CNT Software Synchronisation (ftm_synconf_swrstcnt)
      // CNT Hardware Synchronisation (ftm_synconf_hwrstcnt)
    ...
    * This value is created from Configure.usbdmProject settings
    */
   static constexpr SyncInit DefaultSyncInitValue = {
      FtmSyncCntmin_Disabled , // (ftm_sync_cntmin) Minimum Loading Point Enable - Disabled
      FtmSyncCntmax_Disabled , // (ftm_sync_cntmax) Maximum Loading Point Enable - Disabled
      FtmReinitOnSync_Disabled , // (ftm_sync_reinit) Counter Reinitialisation - Counts normally
      FtmHardwareTrigger(FTM_SYNC_TRIG(0x0)) , // (ftm_sync_trig) Hardware Trigger Inputs
      FtmSyncSynchom_OnRisingClockEdge , // (ftm_sync_synchom) OUTMASK Register Synchronisation - On rising edges of system clock
      FtmSyncPwm_EnhancedPwmSynch , // (ftm_synconf_syncmode) Synchronisation Mode - Enhanced PWM synchronisation
      FtmTriggerClear_OnTrigger , // (ftm_synconf_hwtrigmode) Hardware Trigger Clearing - TRIGj cleared on trigger detect
      FtmBufferSyncCounter_OnRisingClockEdge , // (ftm_synconf_cntinc) CNTIN Register Synchronisation - On rising edges of system clock
      FtmSwSyncRegs_Unaffected , // (ftm_synconf_swwrbuf) CNTIN/MOD/CV Software Synchronisation - Unaffected
      FtmHwSyncRegs_Unaffected , // (ftm_synconf_hwwrbuf) CNTIN/MOD/CV Hardware Synchronisation - Unaffected
      FtmSwSyncOutmask_Unaffected , // (ftm_synconf_swom) OUTMASK Software Synchronisation - Unaffected
      FtmHwSyncOutmask_Unaffected , // (ftm_synconf_hwom) OUTMASK Hardware Synchronisation - Unaffected
      FtmBufferSyncInvctrl_OnRisingClockEdge , // (ftm_synconf_invc) INVCTRL Register Synchronisation - On rising edges of system clock
      FtmSwSyncInvCtrl_Unaffected , // (ftm_synconf_swinvc) INVCTRL Software Synchronisation - Unaffected
      FtmHwSyncInvctrl_Unaffected , // (ftm_synconf_hwinvc) INVCTRL Hardware Synchronisation - Unaffected
      FtmBufferSyncSwoctrl_OnRisingClockEdge , // (ftm_synconf_swoc) SWOCTRL Register Synchronisation - On rising edges of system clock
      FtmHwSyncSwoctrl_Unaffected , // (ftm_synconf_hwsoc) SWOCTRL Hardware Synchronisation - Unaffected
      FtmSwSyncCounter_Unaffected , // (ftm_synconf_swrstcnt) CNT Software Synchronisation - Unaffected
      FtmHwSyncCounter_Unaffected,  // (ftm_synconf_hwrstcnt) CNT Hardware Synchronisation - Unaffected

   };
   
   /**
    * Class used to do initialisation of the Ftm PWM load settings
    ...
    *
    * @code
    * static const Ftm0::PwmLoad FtmPwmLoad {
    *
    ...
    * 
    * // Set up load points
    * FtmPwmLoad.configure();
    *
    * Wait for load to occur
    * FtmPwmLoad.waitForLoadPoint();
    * @endcode
    */
   class PwmLoad {
   ...
   public:
      ...
      // Load Enable (ftm_pwmload_ldok)
      // Load on Channel Match enable (ftm_pwmload_chsel)
      uint16_t pwmload = 0;

      /**
       * Constructor for Load Enable
       * (ftm_pwmload_ldok)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmPwmload Enables loading of MOD/CNTIN/CnV from buffers on load points.
       *        Loading will occur when the FTM counter wraps from MOD value to CNTIN
       *        value or at additional load points specified (e.g. FtmLoadPoint_Ch0)
       *        Loading is further qualified as follows:
       *        - MOD loading is unconditional
       ...
       */
      template <typename... Types>
      constexpr PwmLoad(FtmPwmload ftmPwmload, Types... rest) : PwmLoad(rest...) {
   
         pwmload |= ftmPwmload;
      }
   
      /**
       * Constructor for Load on Channel Match enable
       * (ftm_pwmload_chsel)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmLoadPoint Selects which channels trigger loading of MOD/CNTIN/CnV from buffers.
       *        If enabled, the loading occurs when the counter reaches CnV
       */
      template <typename... Types>
      constexpr PwmLoad(FtmLoadPoint ftmLoadPoint, Types... rest) : PwmLoad(rest...) {
   
         pwmload |= ftmLoadPoint;
      }
      ...
      void waitForLoadPoint() const {
         while (FtmPwmload(ftm->PWMLOAD&FTM_PWMLOAD_LDOK_MASK)) { 
         }
      }

   }; // class Ftm0Info::OutputInitialise
   ...
   static ErrorCode configure(const FaultInit &init) {
      ...
      // Fault Control Mode (ftm_mode_faultm)
      // Action on Fault event (ftm_mode_faultie)
      ftm->MODE = (ftm->MODE&~(FTM_MODE_FAULTM_MASK|FTM_MODE_FAULTIE_MASK)) | init.mode;
    ...
    * This value is created from Configure.usbdmProject settings
    */
   static constexpr FaultInit DefaultFaultInitValue = {
      FtmFaultMode_Disabled , // (ftm_mode_faultm) Fault Control Mode - Disabled
      FtmFaultAction_Ignored , // (ftm_mode_faultie) Action on Fault event - No action
      FtmFaultFilter_Disabled,  // (ftm_fltctrl_ffval) Fault Input Filter - Filter Disabled
   
      // ------ Fault Input 0 ------- 
      FtmFault0Mode_Disabled , // (ftm_fltctrl_fault0en) Fault Input 0 (FTM0_FLT0/CMP0) - Fault input disabled
      FtmFault0Polarity_ActiveHigh,  // (ftm_fltpol_flt0pol) Fault Input 0 Polarity - Active High
   
      // ------ Fault Input 1 ------- 
      FtmFault1Mode_Disabled , // (ftm_fltctrl_fault1en) Fault Input 1 (FTM0_FLT1/CMP1) - Fault input disabled
      FtmFault1Polarity_ActiveHigh,  // (ftm_fltpol_flt1pol) Fault Input 1 Polarity - Active High
   
      // ------ Fault Input 2 ------- 
      FtmFault2Mode_Disabled , // (ftm_fltctrl_fault2en) Fault Input 2 (FTM0_FLT2) - Fault input disabled
      FtmFault2Polarity_ActiveHigh,  // (ftm_fltpol_flt2pol) Fault Input 2 Polarity - Active High
   
      // ------ Fault Input 3 ------- 
      FtmFault3Mode_Disabled , // (ftm_fltctrl_fault3en) Fault Input 3 (FTM0_FLT3) - Fault input disabled
      FtmFault3Polarity_ActiveHigh,  // (ftm_fltpol_flt3pol) Fault Input 3 Polarity - Active High
   };
   ...
   /**
    * Class used to do initialisation of the FtmOutput initilisation settings
    ...
    *
    * @code
    * static const Ftm0::OutputInitialise FtmOutputInitialise {
    *
    *    // Output levels
    *    FtmInitialValue,         //...
    * };
   ...
   public:
      ...
      // Channel Output Initialisation Value (ftm_outinit_choi)
      uint8_t outinit = 0;

      /**
       * Constructor for Channel Output Initialisation Value
       * (ftm_outinit_choi_masks)
       *
       * @tparam   Types
       * @param    rest
       *
       * @param ftmInitialValue Bitmask defining the value that is forced
       *        into the channel output when initialisation occurs.
       */
      template <typename... Types>
      constexpr OutputInitialise(FtmInitialValue ftmInitialValue, Types... rest) : OutputInitialise(rest...) {
   
         outinit = (outinit&(ftmInitialValue>>8)) | ftmInitialValue;
      }
       ...
       */
      template <typename... Types>
      constexpr OutputInitialise(uint16_t ftmInitialValue, Types... rest) : OutputInitialise(rest...) {
   
         outinit = ftmInitialValue;
      }
      ...
      void apply() const {
         ...
         // Initialisation of Channel Outputs (ftm_mode_init)
         ftm->MODE=ftm->MODE|FtmInitialiseOutputs_Initialise;
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: FTM0_CH2             = PTC3(p46)                      */  { PinIndex::PTC3,         PcrValue(0x00400UL) },
         /*   3: FTM0_CH3             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   4: FTM0_CH4             = PTD4(p61)                      */  { PinIndex::PTD4,         PcrValue(0x00400UL) },
         /*   5: FTM0_CH5             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   6: FTM0_CH6             = PTD6(p63)                      */  { PinIndex::PTD6,         PcrValue(0x00400UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   3: LLWU_P3              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   4: LLWU_P4              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   5: LLWU_P5              = PTB0(p35)                      */  { PinIndex::PTB0,         PcrValue(0x08100UL) },
         /*   6: LLWU_P6              = PTC1(p44)                      */  { PinIndex::PTC1,         PcrValue(0x08100UL) },
         /*   7: LLWU_P7              = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   8: LLWU_P8              = PTC4(p49)                      */  { PinIndex::PTC4,         PcrValue(0x08100UL) },
         ...
         /*  12: LLWU_P12             = PTD0(p57)                      */  { PinIndex::PTD0,         PcrValue(0x08100UL) },
         /*  13: LLWU_P13             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  14: LLWU_P14             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
...
public:
   ...
   static constexpr ChannelInit DefaultChannelInitValues[] = {
      ...
      PitChannelChain_Disabled , // (pit_tctrl_chn[2]) Chain with previous channel - Timers are not chained
      ...
      PitChannelChain_Disabled , // (pit_tctrl_chn[3]) Chain with previous channel - Timers are not chained
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: VBAT                 = VBAT(p21)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: VDD1                 = VDD1(p3)                       */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   2: VDD2                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   3: VDD3                 = VDD3(p30)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   4: VDD4                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   5: VDD                  = VDD5(p48)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   6: VDD6                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   7: VDD7                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   8: VDDA                 = VDDA(p13)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   9: VOUT33               = VOUT33(p7)                     */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  10: VREFH                = VREFH(p14)                     */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  11: VREFL                = VREFL(p15)                     */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  12: VREGIN               = VREGIN(p8)                     */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  13: VSS1                 = VSS1(p4)                       */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  14: VSS1a                = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  15: VSS2                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  16: VSS3                 = VSS3(p31)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  17: VSS4                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  18: VSS                  = VSS5(p47)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*  19: VSS6                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  20: VSS7                 = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*  21: VSSA                 = VSSA(p16)                      */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
   };
...
public:
   ...
   public:
      ...
      /**
       * Constructor for Allow High Speed Run mode
       *
       * @tparam   Types
       * @param    rest
       *
      ...
      /**
       * Constructor for Partial Stop Mode
       *
       * @tparam   Types
       * @param    rest
       *
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: SPI0_SCK             = PTC5(p50)                      */  { PinIndex::PTC5,         PcrValue(0x00200UL) },
         /*   1: SPI0_SIN             = PTD3(p60)                      */  { PinIndex::PTD3,         PcrValue(0x00200UL) },
         /*   2: SPI0_SOUT            = PTC6(p51)                      */  { PinIndex::PTC6,         PcrValue(0x00200UL) },
         /*   3: SPI0_PCS0            = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   4: SPI0_PCS1            = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   5: SPI0_PCS2            = PTC2(p45)                      */  { PinIndex::PTC2,         PcrValue(0x00200UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: SPI1_SIN             = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
         /*   2: SPI1_SOUT            = --                             */  { PinIndex::UNMAPPED_PCR, PcrValue(0)         },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: UART0_TX             = PTA2(p24)                      */  { PinIndex::PTA2,         PcrValue(0x08200UL) },
         /*   1: UART0_RX             = PTA1(p23)                      */  { PinIndex::PTA1,         PcrValue(0x08200UL) },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: UART1_TX             = PTE0(p1)                       */  { PinIndex::PTE0,         PcrValue(0x08300UL) },
         /*   1: UART1_RX             = PTE1(p2)                       */  { PinIndex::PTE1,         PcrValue(0x08300UL) },
...
public:
   ...
   public:
      ...
      uint8_t clk_recover_ctrl = 0;

      /// IRC48M oscillator enable register
      uint8_t clk_recover_irc_en = 0;

      /**
       * Constructor for IRC48M mode for USB operation
       *
       * @tparam   Types
       * @param    rest
       *
       ...
       */
      template <typename... Types>
      constexpr ClockRecoveryInit(UsbIrc48mClockTrackingMode usbIrc48mClockTrackingMode, Types... rest) : ClockRecoveryInit(rest...) {
   
         clk_recover_ctrl = (clk_recover_ctrl&~(USB_CLK_RECOVER_CTRL_CLOCK_RECOVER_EN_MASK|USB_CLK_RECOVER_CTRL_RESET_RESUME_ROUGH_EN_MASK)) | usbIrc48mClockTrackingMode;
      }
   
      /**
       * Constructor for Restart from IFR trim value
       *
       * @tparam   Types
       * @param    rest
       *
       ...
       */
      template <typename... Types>
      constexpr ClockRecoveryInit(UsbIrc48mClockResetTrim usbIrc48mClockResetTrim, Types... rest) : ClockRecoveryInit(rest...) {
   
         clk_recover_ctrl = (clk_recover_ctrl&~USB_CLK_RECOVER_CTRL_RESTART_IFRTRIM_EN_MASK) | usbIrc48mClockResetTrim;
      }
   
      /**
       * Constructor for IRC48M enable
       *
       * @tparam   Types
       * @param    rest
       *
       * @param usbIrc48mClockEnable This is used to control when the the on-chip IRC48M module is enabled
       *        It will also be enabled if selected as a peripheral clock or MCG clock source if powered
       *        It can be used as a clock source for FS USB device mode operation
       */
      template <typename... Types>
      constexpr ClockRecoveryInit(UsbIrc48mClockEnable usbIrc48mClockEnable, Types... rest) : ClockRecoveryInit(rest...) {
   
         clk_recover_irc_en = (clk_recover_irc_en&~(USB_CLK_RECOVER_IRC_EN_IRC_EN_MASK|USB_CLK_RECOVER_IRC_EN_REG_EN_MASK)) | usbIrc48mClockEnable;
      }
...
public:
   ...
   /**
    * Default initialisation value for Usb0
    * This value is created from Configure.usbdmProject settings
    */
   static constexpr ClockRecoveryInit DefaultClockRecovery = {
      UsbIrc48mClockTrackingMode_RoughAndFineTracking , // (usb_clk_recover_ctrl_tracking_mode) IRC48M mode for USB operation - Revert to rough tracking on USB reset or resume
      UsbIrc48mClockResetTrim_Restart , // (usb_clk_recover_ctrl_restart_ifrtrim_en) Restart from IFR trim value - Restart from factory trim value
      UsbIrc48mClockEnable_PeripheralAndUsb,  // (usb_clk_recover_irc_en_irc_en) IRC48M enable - Available as general and USB clock source
   };
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: USB0_DM              = USB0_DM(p6)                    */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
         /*   1: USB0_DP              = USB0_DP(p5)                    */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  PinIndex                PCR value
         /*   0: VREF_OUT             = VREF_OUT(p17)                  */  { PinIndex::FIXED_NO_PCR, PcrValue(0)         },
   };
