...
constexpr CmpInputPlus   Cmp0InputPlus_Ptc7        = CmpInputPlus_1;      ///< Mapped pin PTC7(p52)
constexpr CmpInputMinus  Cmp0InputMinus_Ptc7       = CmpInputMinus_1;     ///< Mapped pin PTC7(p52)
constexpr CmpInputPlus   Cmp0InputPlus_Dac1Out     = CmpInputPlus_4;      ///< Fixed pin  DAC1_OUT(Internal)
constexpr CmpInputMinus  Cmp0InputMinus_Dac1Out    = CmpInputMinus_4;     ///< Fixed pin  DAC1_OUT(Internal)
constexpr CmpInputPlus   Cmp0InputPlus_VrefOut     = CmpInputPlus_5;      ///< Fixed pin  VREF_OUT(p17)
constexpr CmpInputMinus  Cmp0InputMinus_VrefOut    = CmpInputMinus_5;     ///< Fixed pin  VREF_OUT(p17)
constexpr CmpInputPlus   Cmp0InputPlus_Bandgap     = CmpInputPlus_6;      ///< Fixed pin  BANDGAP(Internal)
constexpr CmpInputMinus  Cmp0InputMinus_Bandgap    = CmpInputMinus_6;     ///< Fixed pin  BANDGAP(Internal)
constexpr CmpInputPlus   Cmp0InputPlus_CmpDac      = CmpInputPlus_7;      ///< Fixed pin  CMP_DAC(Internal)
constexpr CmpInputMinus  Cmp0InputMinus_CmpDac     = CmpInputMinus_7;     ///< Fixed pin  CMP_DAC(Internal)
