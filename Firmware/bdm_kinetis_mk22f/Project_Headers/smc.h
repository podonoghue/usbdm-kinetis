...
public:
   ...
   static constexpr Init DefaultInitValue = {
      SmcAllowHighSpeedRun_Enabled , // (smc_pmprot_ahsrun) Allow High Speed Run mode - HSRUN is allowed
      SmcAllowVeryLowPower_Enabled , // (smc_pmprot_avlp) Allow Very Low Power modes - VLPR, VLPW and VLPS are allowed
      SmcAllowLowLeakageStop_Disabled , // (smc_pmprot_alls) Allow Low Leakage Stop mode - LLS is not allowed
      ...
      SmcPartialStopMode_Normal , // (smc_stopctrl_pstopo) Partial Stop Mode - STOP - Normal Stop mode
