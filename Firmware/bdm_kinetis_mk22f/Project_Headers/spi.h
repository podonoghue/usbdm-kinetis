...
// SPI0 mappings
static constexpr SpiPeripheralSelect SpiPeripheralSelect_Ptc2         = SpiPeripheralSelect_Pcs2; ///< BKGD/SWD_DIR output from SPI.PCS (swd) (PTC2(p45))
static constexpr SpiPeripheralSelect SpiPeripheralSelect_SwdDir       = SpiPeripheralSelect_Pcs2; ///< BKGD/SWD_DIR output from SPI.PCS (swd) (PTC2(p45))
