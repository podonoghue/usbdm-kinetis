...
const ClockInfo Mcg::clockInfo[] = {
   {  // ClockConfig_FEE_IRC48MHz (McgClockMode_FEE)
      ...
      SIM_CLKDIV1_OUTDIV3(1) | // Flexbus Clock Divider (OUTDIV3) - Divide by [1-16] - /2
      SIM_CLKDIV1_OUTDIV2(0) | // Bus Clock Divider (OUTDIV2) - Divide by [1-16] - /1
      SIM_CLKDIV1_OUTDIV1(0),  // Core & System Clock Divider (OUTDIV1) - Divide by [1-16] - /1

      Sim::DefaultSopt2Values[ClockConfig_FEE_IRC48MHz].sopt2,

      /// Clock Mode 
      McgClockMode_FEE,  // Default Clock Mode - FLL Engaged External (FEE)

      /// Run Mode 
      SmcRunMode_Normal,  // Run mode - Normal RUN

      /// Control Register 1 - Excluding CLKS, IREFS 
      McgFllPrescale_HighDivBy1280 | // FLL External Reference Divider - /1280 (high)
      ...
      /// Control Register 7 
      McgErcSelect_Irc48MHz,  // MCG External reference clock - IRC 48MHz clock
