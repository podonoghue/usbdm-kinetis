...
VectorTable const __vector_table = {
   ...
   &__StackTop,                                /*    0   -16  Initial stack pointer                                                            */
   {
      ...
      USBDM::PortA::irqHandler,                /*   75,   59  General Purpose Input/Output                                                     */
      PORTB_IRQHandler,                        /*   76,   60  General Purpose Input/Output                                                     */
      USBDM::PortC::irqHandler,                /*   77,   61  General Purpose Input/Output                                                     */
      USBDM::PortD::irqHandler,                /*   78,   62  General Purpose Input/Output                                                     */
