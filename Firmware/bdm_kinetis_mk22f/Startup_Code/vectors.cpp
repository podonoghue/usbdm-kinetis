...
VectorTable const __vector_table = {
   ...
   &__StackTop,                                /*    0   -16  Initial stack pointer                                                            */
   {
      ...
      Uart1::RxTx_irqHandler,                  /*   49,   33  Serial Communication Interface                                                   */
      Uart1::Error_irqHandler,                 /*   50,   34  Serial Communication Interface                                                   */
      ...
      Cmp0::irqHandler,                        /*   56,   40  High-Speed Comparator                                                            */
      ...
      Usb0::irqHandler,                        /*   69,   53  Universal Serial Bus                                                             */
      ...
      PortA::irqHandler,                       /*   75,   59  General Purpose Input/Output                                                     */
      PORTB_IRQHandler,                        /*   76,   60  General Purpose Input/Output                                                     */
      PortC::irqHandler,                       /*   77,   61  General Purpose Input/Output                                                     */
      PortD::irqHandler,                       /*   78,   62  General Purpose Input/Output                                                     */
