 ...
 */
class UsbLed : private USBDM::Usb_Led { // public USBDM::GpioD<7, USBDM::ActiveLow> {
public:
   using USBDM::Usb_Led::toggle;
   using USBDM::Usb_Led::on;
   using USBDM::Usb_Led::off;
   using USBDM::Usb_Led::write;
