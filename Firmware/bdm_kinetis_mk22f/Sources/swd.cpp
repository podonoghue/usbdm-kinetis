...
CreatePeripheralPinChecker("SWD");

// Make sure pins have been assigned to SPI
CheckPinExistsAndIsMapped<SpiInfo, 0> sck_chk;         // SWCLK_O pin
CheckPinExistsAndIsMapped<SpiInfo, 1> sin_chk;         // SWD_I pin
CheckPinExistsAndIsMapped<SpiInfo, 2> sout_chk;        // SWD_O pin
CheckPinExistsAndIsMapped<SpiInfo, 5> enable_chk;      // SWD_DIR pin (automatic switching via SPI)
...
class swdDioControl{
   ...
   /** GPIO for SWD_DIR pin / Shared with SPI  */
   using swdDir = GpioTable_T<SpiInfo, 5, ActiveHigh>;
