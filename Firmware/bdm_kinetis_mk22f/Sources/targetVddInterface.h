...
private:
    ...
    */
   static constexpr int onMinThreshold5VAdc = (int)((4.75/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));

   /**
    * Maximum working input 5V voltage as an ADC reading \n
    * 5V-5% as ADC reading i.e. 0-255
    */
   static constexpr int onMaxThreshold5VAdc = (int)((5.25/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));

   /**
    * Minimum working input 3.3V voltage as an ADC reading \n
    * 3.3-5% as ADC reading i.e. 0-255
    */
   static constexpr int onMinThreshold3V3Adc = (int)((3.153/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));

   /**
    * Maximum working input 3.3V voltage as an ADC reading \n
    * 3.3+5% as ADC reading i.e. 0-255
    */
   static constexpr int onMaxThreshold3V3Adc = (int)((3.47/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));

   /**
    * Minimum working input 1.5V voltage as an ADC reading \n
    * 1.5-5% as ADC reading i.e. 0-255
    */
   static constexpr int onMinThreshold1V5Adc = (int)((1.4/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));
    ...
    */
   static constexpr int powerOnResetThresholdAdc = (int)((0.8/(externalDivider*Vref))*(USBDM::InterfaceAdc::getSingleEndedMaximum(USBDM::AdcResolution_8bit_se)));
...
public:
   ...
   static void vddMonitorCallback(const USBDM::CmpStatus &status) {
      if (status.event == USBDM::CmpEventId_FallingEdge) {
         // Falling edge
         switch(vddState) {
      ...
      if (status.event == USBDM::CmpEventId_RisingEdge) {
         // Rising edge
         switch(vddState) {
            case VddState_Internal:
               break;
   ...
   static void initialise(void (*callback)(VddState)) {
      ...
      Control::setOutput();
      static constexpr VddMeasure::OwningAdc::Init adcInit {
         AdcResolution_8bit_se,
         AdcClockSource_BusClock,
         AdcSample_4cycles};

      // Do default calibration for 8-bits
      VddMeasure::OwningAdc::configure(adcInit);
