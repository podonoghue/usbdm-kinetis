...
void mapAllPins() {
   ...
   PORTB->GPCLR = ForceLockedPins|0x0000UL|PORT_GPCLR_GPWE(0x0004UL);
   PORTB->GPCLR = ForceLockedPins|0x0100UL|PORT_GPCLR_GPWE(0x000BUL);
   PORTC->GPCLR = ForceLockedPins|0x0000UL|PORT_GPCLR_GPWE(0x0080UL);
   PORTC->GPCLR = ForceLockedPins|0x0100UL|PORT_GPCLR_GPWE(0x0013UL);
   ...
   PORTD->GPCLR = ForceLockedPins|0x0100UL|PORT_GPCLR_GPWE(0x0083UL);
